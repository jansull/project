...
<head>
    ...
    function LocalSave(gubun){
    	...
    	notice_write.action="LocalFood?t_gubun=local_save";
    	notice_write.submit();
   }
    </script>
    <script>
        ...
        <div id="container">
            ...
            <div id="sub_wrap">
                <div class="wrap">
                    ...
                    <section id="right_wp">
                        <div class="sub_info">
                            <div class="sub_title"><h3>로컬 먹거리 직구</h3></div>
                        </div>
                        <div id="contents">
                        ...
                        <div>
                            ...
                            <input type="button" onclick="LocalSave();" value="글쓰기" class="custom-btn btn-1" style="float: right;">
                          </form>
                    </section>
                </div>
            </div>
