        ...
        <div id="container">
            ...
            <div id="sub_wrap">
                <div class="wrap">
                    ...
                    <section id="right_wp">
                        <div class="sub_info">
                            <div class="sub_title"><h3 style="font-family: 'KimjungchulMyungjo-Bold';">녹색사업</h3></div>
                        </div>
                        <div id="contents" style="text-align: center;">
                            <div>
                            <img src="2_program/picture/main image/녹색사업.jpg" style="width: 50%; border: rgb(178, 222, 154) solid 5px;">
                            <br>
                                <input type="button" onclick="goApply('reserve_user')" value="체험신청 바로가기" class="custom-btn btn-1">
                                <h2>녹색사업</h2>
                                <p style="font-family: 'KimjungchulMyungjo-Light';">산림복지 진흥원이 주최하고 복권기금으로 활용되는 녹색사업은  우리사회의 소외계층과 국가와 사회를 위해 헌신을 다한 다수의 국민들을 위해 제공되는 프로그램으로 지역 사회와의 긍정적인 상호작용을 중시하며, 지역 발전에 기여하는 것을 목표로 삼고 있습니다. 사회적 책임을 다하고 지속가능한 발전을 이끄는 책임감 있는 기업으로 소속되기 위해 노력하고 있습니다.</p>
                            </div>
                            <div>
                                <img src="2_program/picture/sub image/농임업 임산물.jpg" style="width: 30%; border: rgb(178, 222, 154) solid 5px;">
                                <img src="2_program/picture/sub image/산림에코힐링.jpg" style="width: 30%; border: rgb(178, 222, 154) solid 5px;">
                                <img src="2_program/picture/sub image/주말농장.jpg" style="width: 30%; border: rgb(178, 222, 154) solid 5px;">
                            </div>
