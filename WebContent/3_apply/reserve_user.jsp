                        ...
                        <div id="contents">
                         ...
                         <form name="reserve_member">
                          <input type="hidden" name="t_gubun">
                            <div class="col">
                                <div class="wrap0">
                                    ...
                                    <select name="header_check" id="selectBox">
                                        <option value="" selected disabled hidden>말머리 선택</option> 
                                        <option value="2">신규 방문</option>
                                        <option value="3">재방문</option>
                                        <option value="4">기타</option>
                                    </select>
                                    <input type="text" id="user_password" name="user_password" placeholder="비밀번호 입력">
                                    <input type="text" id="user_title" name="user_title" placeholder="제목을 입력해 주세요.">
                                    ...
                                    <div class="item01">
                                        <div class="item1">
                                            ...
                                            <select onchange="categoryChange(this)" name="program_index" id="classification_selectBox">
                                                ...
                                                <option value="a">기관 숲체험 프로그램</option>
                                                <option value="b">녹색사업</option>
                                                <option value="c">숲치유</option>
                                                <option value="d">학교환경교육</option>
                                                <option value="e">지역생태모니터링</option>
                                            </select>
                                        </div>
                                ...
                                <div class="wrap2 wrap_common">
                                    ...
                                    <div class="item02">
                                        <div class="item1">
                                            <span>예약일시</span>
                                            <br>
                                            <input type="date" data-placeholder="등록일" name="apply_date">
                                        ...
                                        <div class="item3">
                                            ...
                                            <div class="item3_2">
                                                <span>영유아</span>
                                                <input type="text" name="kid_count">
                                                <h5>명</h5>
                                            </div>
                                            <div class="item3_1">
                                                <span>청소년</span>
                                                <input type="text" name="teen_kid_count">
                                                <h5>명</h5>
                                            </div>
                                            <div class="item3_1">
                                                <span>초등</span>
                                                <input type="text" name="elementary_count">
                                                <h5>명</h5>
                                            </div>
                                            <div class="item3_1">
                                                <span>성인</span>
                                                <input type="text" name="adult_count">
                                                <h5>명</h5>
                                            </div>
                                            <!-- <div class="item3_1">
                                                <span>고등</span>
                                        ...
                                        <table>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="write_name" id="wr_1" required class="frm_input required" size="10" maxlength="20" placeholder="성명 입력">
                                                    </td>
                                                </tr>
                                                <!-- 2번째 / 단체ㆍ기관명 -->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="agency_name" id="wr_2" required class="frm_input required" size="10" maxlength="20" placeholder="단체·기관명 입력">
                                                    </td>
                                                </tr>
                                                <!-- 3번째 / 전화번호 -->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="tell_1" id="wr_3" required class="frm_input required" size="3" maxlength="3" placeholder="" style="width: 50px;">
                                                        <input type="text" name="tell_2" id="wr_3" required class="frm_input required" size="4" maxlength="4" placeholder="" style="width: 50px;">
                                                        <input type="text" name="tell_3" id="wr_3" required class="frm_input required" size="4" maxlength="4" placeholder="" style="width: 50px;">
                                                    </td>
                                                </tr>
                                                <!-- 4번째 / 이메일 -->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="email" id="wr_4" required class="frm_input required" size="10" maxlength="20" placeholder="이메일을 입력해주세요.">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <div class="col"></div>
                            <input type="button" onclick="goMemberReserve()" value="글쓰기" class="custom-btn btn-1" style="float: right;">
                    </section>
                </div>
            </div>
        </div>
