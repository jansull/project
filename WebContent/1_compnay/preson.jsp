...
<body>
 <form name="pagemove">
    ...
    <div class="all">
        ...
        <section class="section_real" style="height: 1200px;">
        ...
        <div id="container">
            ...
            <div class="location">
                <ol class="wrap">
                    ...
                    <li><a href="preson.html">조직도</a></li>
                </ol>
            </div>
            <div id="sub_wrap">
                <div class="wrap">
                    ...
                    <section id="right_wp">
                        <div class="sub_info">
                            <div class="sub_title"><h3 style="font-family: 'KimjungchulMyungjo-Bold';">조직도</h3></div>
                        </div>
                        <div id="contents">
                            <img src="image/조직도2.png" style=" width: 100%;">
                        </div>
                    </section>
                </div>
            </div>
